...
const allLogs = [
  {
  ts: "13 Jun 2026, 11:20 AM",
  user: "Finance Manager",
  action: "Viewed Utilization Certificate for Rahul Sharma",
  module: "Fellow Utilization",
  status: "Info",
},
{
  ts: "13 Jun 2026, 11:30 AM",
  user: "Finance Manager",
  action: "Generated Statement of Expenditure for Rahul Sharma",
  module: "Fellow Utilization",
  status: "Success",
},
...
const timeline = [
  {title: "UC Generated",desc: "Utilization Certificate generated for Rahul Sharma",time: "11:30 AM",color: "#16a34a",},
  {title: "SOE Prepared",desc: "Statement of Expenditure updated",time: "11:20 AM",color: "#2563eb",},
          ...
          <div className="fin-card-body">
            <div className="fin-search-row">
              ...
              <select className="fin-select" value={moduleFilter} onChange={(e) => setModuleFilter(e.target.value)}>
                {["All","Budget","Bills","Reports","Dashboard","Audit","Fellow Utilization",].map((m) => <option key={m}>{m}</option>)}
              </select>
